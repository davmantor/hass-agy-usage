#!/bin/bash
# Deploy hass-antigravity-usage to local Home Assistant config
set -e

SRC="$(dirname "$0")/custom_components/hass_antigravity_usage"
DEST="/home/trick/docker-services/hass-config/custom_components/hass_antigravity_usage"
